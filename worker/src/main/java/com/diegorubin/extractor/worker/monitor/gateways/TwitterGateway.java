package com.diegorubin.extractor.worker.monitor.gateways;

import com.diegorubin.extractor.worker.monitor.domain.WorkerStatus;
import com.diegorubin.extractor.worker.monitor.gateways.listeners.SimpleListener;
import com.diegorubin.extractor.worker.monitor.gateways.listeners.assembler.TwitterAssembler;
import com.diegorubin.extractor.worker.nlp.usecases.ProcessMessage;
